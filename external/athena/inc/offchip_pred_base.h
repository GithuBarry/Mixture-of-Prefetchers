...
public:
  ...
  void update_dram_bw(uint8_t _dram_bw) {
    dram_bw = _dram_bw;
  }
  ...
  //----------------------------------------------//
  // Functionality for offchip predictor
  //----------------------------------------------//
  ...
  //----------------------------------------------//
  // Functionality for prefetch filtering
  //----------------------------------------------//
  virtual bool predict_on_prefetch(PACKET &pf_packet) {
    return false; // Default implementation: don't filter prefetches
  }
  virtual void train_on_prefetch(PACKET &pf_packet) {
