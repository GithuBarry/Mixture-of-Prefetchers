/*****************************************************************************************
 * This file implements the the ensemble version of Hit-miss predictor (HMP)
 *introduced in: Yoaz, A., Erez, M., Ronen, R., & Jourdan, S., "Speculation
 *techniques for improving load related instruction scheduling", ISCA 1999
