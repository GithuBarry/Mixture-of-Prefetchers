...
string ddrp_monitor_config_string[] = {"DDRP_ON_DP_ON", "DDRP_ON_DP_OFF", "DDRP_OFF_DP_ON", "DDRP_OFF_DP_OFF"};
...
DDRPMonitor::DDRPMonitor(uint32_t _cpu) : cpu(_cpu) {
  ...
  // {
  //     assert(knob::l2c_prefetcher_types[index] == "none" ||
  //     knob::l2c_prefetcher_types[index] == "scooby");
  // }
...
void DDRPMonitor::print_config() {
  cout << "ddrp_monitor_exploit_epoch " << knob::ddrp_monitor_exploit_epoch << endl
       << "ddrp_monitor_explore_epoch " << knob::ddrp_monitor_explore_epoch
       << endl
       //  << "ddrp_monitor_scooby_reward_incorrect " <<
       //  knob::ddrp_monitor_scooby_reward_incorrect << endl
       //  << "ddrp_monitor_scooby_reward_none " <<
       //  knob::ddrp_monitor_scooby_reward_none << endl
...
void DDRPMonitor::set_params() {
  if (config == ddrp_monitor_config_t::DDRP_ON_DP_ON) {
    ...
    // knob::scooby_reward_incorrect =
    // knob::ddrp_monitor_scooby_reward_incorrect; knob::scooby_reward_none =
    // knob::ddrp_monitor_scooby_reward_none;
...
ddrp_monitor_config_t DDRPMonitor::get_winner_config() {
  ...
  MYLOG(warmup_complete[cpu],
        "cycle_DDRP_ON_DP_ON: %ld cycle_DDRP_ON_DP_OFF: %ld "
        "cycle_DDRP_OFF_DP_ON: %ld cycle_DDRP_OFF_DP_OFF: %ld",
