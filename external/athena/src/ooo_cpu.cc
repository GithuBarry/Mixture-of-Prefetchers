...
og_state_t *O3_CPU::og_capture_state() {
  ...
  if (knob::og_multi_prefetcher_enable) {
    if (knob::og_coordination_mode == "l1d_l2c") {
      ...
      sys_state->pref_issued[0] = L1D.l1d_prefetchers[0]->get_issued_prefetches();
      sys_state->pref_issued[1] = L2C.prefetchers[0]->get_issued_prefetches();
      sys_state->pref_useful[0] = L1D.l1d_prefetchers[0]->get_useful_prefetches();
      sys_state->pref_useful[1] = L2C.prefetchers[0]->get_useful_prefetches();
      ...
      sys_state->pref_issued[0] = L2C.prefetchers[0]->get_issued_prefetches();
      sys_state->pref_issued[1] = L2C.prefetchers[1]->get_issued_prefetches();
      sys_state->pref_useful[0] = L2C.prefetchers[0]->get_useful_prefetches();
      sys_state->pref_useful[1] = L2C.prefetchers[1]->get_useful_prefetches();
    }
  } else {
