...
string POWER7_Pref::get_mode_string(Mode mode) {
  switch (mode) {
  case Mode::Explore:
    return string("Explore");
  case Mode::Exploit:
    return string("Exploit");
  default:
    return string("UNK");
  }
}
...
string POWER7_Pref::get_config_string(Config cfg) {
  ...
  case Config::Shallowest:
    return string("Shallowest");
  case Config::S_Shallowest:
    return string("S_Shallowest");
  case Config::Shallow:
    return string("Shallow");
  case Config::S_Shallow:
    return string("S_Shallow");
  case Config::Medium:
    return string("Medium");
  case Config::S_Medium:
    return string("S_Medium");
  case Config::Deep:
    return string("Deep");
  case Config::S_Deep:
    return string("S_Deep");
  case Config::Deeper:
    return string("Deeper");
  case Config::S_Deeper:
    return string("S_Deeper");
  case Config::Deepest:
    return string("Deepest");
  case Config::S_Deepest:
    return string("S_Deepest");
  default:
    return ("UNK");
  }
}
...
void POWER7_Pref::init_knobs() {
  // assert(knob::power7_exploit_epoch >=
  // knob::power7_explore_epoch*Config::NumConfigs);
}
...
uint32_t POWER7_Pref::get_streamer_degree(Config config) {
  switch (config) {
  case Config::Default:
    return knob::power7_default_streamer_degree;
  case Config::Off:
    return 0;
  case Config::Shallowest:
  case Config::S_Shallowest:
