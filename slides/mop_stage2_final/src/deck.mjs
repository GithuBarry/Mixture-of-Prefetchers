        ...
        [
          ...
          keyValueRows(
            [
              ...
              ["Heldout", "7 frozen traces, 5M warmup, 10M simulation"],
    ...
    [
      ...
      column(
        ...
        [
          image({
            name: "win-loss",
            dataUrl: pngDataUrl("win_loss_mop_vs_best_single.png"),
            contentType: "image/png",
            width: fill,
            height: fill,
            fit: "contain",
            alt: "Win loss comparison against best single prefetcher",
          }),
          figureCaption("Caption: Blue rows are trace-level wins versus the best single prefetcher. Pink rows are losses. The mixed pattern motivates the measured heldout claim."),
        ],
      ),
    ],
  ),
      ...
      column(
        ...
        [
          image({
            ...
            dataUrl: pngDataUrl("single_expert_profiles.png"),
            contentType: "image/png",
            width: fill,
            height: fill,
            fit: "contain",
            alt: "Single expert profiles across traces",
          }),
          figureCaption("Caption: The scatter shows which single expert wins by trace. Different trace winners create room for a router to approach the dark-blue best-expert reference."),
        ],
      ),
      column(
      ...
      column(
        ...
        [
          image({
            ...
            dataUrl: pngDataUrl("router_compare_criterion.png"),
            contentType: "image/png",
            width: fill,
            height: fill,
            fit: "contain",
            alt: "Router comparison criterion plot",
          }),
          figureCaption("Caption: The comparison keeps the baseline routers plain. MoP-V2 clears the simple router baselines on the 13-trace final validation surface."),
        ],
      ),
    ],
  ),
      ...
      column(
        ...
        [
          image({
            ...
            dataUrl: pngDataUrl("moplite_action_distribution.png"),
            contentType: "image/png",
            width: fill,
            height: fill,
            fit: "contain",
            alt: "MoP action distribution across traces",
          }),
          figureCaption("Caption: The action distribution keeps the tuned policy interpretable by showing how often the router selects each action across final traces."),
        ],
      ),
      column(
